...
Unlike the backend services, Balrog's UI cannot be rolled back to an earlier release. If UI changes need to be reverted you must:

1. Submit a pull request to revert the faulty code changes.

2. Merge the pull request.

3. Re-run the "Build and Deploy Balrog UI" GitHub action (see above).
